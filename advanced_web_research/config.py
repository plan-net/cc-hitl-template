...
DEFAULT_CONFIG = {
    "completion_mode": "auto-complete",  # Auto-finalize when Claude completes
    "upload_files": False,  # Disabled - causes errors with Kodosumi API
    "max_turns": 50,
    "file_exclusions": [
        # Source code files
        ".py", ".pyc", ".pyo", ".pyd",
        ...
        # Build files
        "justfile", "Makefile", "PKG-INFO", "METADATA",
