...
orb -m ray-cluster bash -c "sudo -u kodosumi bash -c 'echo YOUR_GITHUB_TOKEN | podman login ghcr.io -u YOUR_GITHUB_USERNAME --password-stdin'"
...
xxxxxxxx      ghcr.io/plan-net/claude-hitl-worker:latest  Up X minutes  some_name
```
